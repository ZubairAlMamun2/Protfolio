...
const skills = [
  ...
  { category: "Backend & Databases", items: [
...
const Skills=()=> {
  ...
  return (
    <section id="skils" ref={ref} className="bg-[#0f0f1a] text-white py-16 px-6 md:px-16">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {skills.map((skillSet, index) => (
          <div key={index} className="mb-10">
            <h3 className="text-2xl font-semibold text-gray-300 mb-4">{skillSet.category}</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 justify-center">
              {skillSet.items.map((skill, i) => (
                <motion.div
                  ...
                  className="bg-gray-800 p-4 rounded-xl shadow-lg flex flex-col items-center hover:bg-purple-600 transition-all cursor-pointer"
                >
