        ...
        <div className="bg-gray-800 p-6 rounded-xl  md:full shadow-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSDbFVrlnXdlzkqsdGkFZwBkfKKDFhMbQjhwmbmsgstjLDtfFkXDXzqhVbwJzpQnbxDKZLbZ" target="_blank" className="text-lg text-blue-400 hover:underline">
